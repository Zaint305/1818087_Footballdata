const ApiKey = "3e245348f8c64afcba5d18ef5c703830";
        ...
        .then(resJson => {
            ...
            resJson.teams.forEach(team => {
                ...
                <li class="collection-item avatar">
                    ...
                    <a href="#!" data-id= "${team.id}" class="secondary-content"><i class="material-icons">info</i></a>
                </li>
                `
            });
        ...
        .then(resJson => {
            ...
            resJson.teams.forEach(team =>  {
                teams = `
                   ...
                   <p><h3>${team.name}  (${team.tla})</h3></p>
                     <p> <h5> Berdiri: ${team.founded} <br>
                     Markas: ${team.venue} <br>
                     Alamat: ${team.address} <br>
                     Warna Club: ${team.clubColors}</h5> 
                     </p>
                   </div>
                </div>
            </div>
